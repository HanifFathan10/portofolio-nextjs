      ...
      content: (
        <ul className="flex gap-2 pl-2 font-semibold text-base text-[#eaeaea]">
          <div className="flex flex-col justify-center mt-4">
            ...
            <li className="flex gap-2 mt-2">
              <Image src={"/svg/javascript.svg"} alt="javascript" width={20} height={20} />
              <h5 className="text-xs md:text-base">JAVASCRIPT</h5>
            </li>
            <li className="flex gap-2 mt-2">
              <Image src={"/svg/bootstrap.svg"} alt="bootstrap" width={20} height={20} />
              <h5 className="text-xs md:text-base">BOOTSTRAP</h5>
            </li>
            <li className="flex gap-2 mt-2">
              <Image src={"/svg/tailwind.svg"} alt="tailwind" width={20} height={20} />
              <h5 className="text-xs md:text-base">TAILWIND CSS</h5>
            </li>
            <li className="flex gap-2 mt-2">
              <Image src={"/svg/react.svg"} alt="react" width={20} height={20} />
              <h5 className="text-xs md:text-base">REACT JS</h5>
            </li>
          </div>
          <div className="flex flex-col mt-2 ml-2">
            <li className="flex gap-2 mt-2">
              <Image src={"/svg/next.svg"} alt="next" width={20} height={20} className="bg-[#eaeaea] rounded-xl p-[2px] " />
              <h5 className="text-xs md:text-base">NEXT JS</h5>
            </li>
            <li className="flex gap-2 mt-2">
              <Image src={"/svg/typescript.svg"} alt="typescript" width={20} height={20} />
            ...
            <li className="flex gap-2 mt-2">
              <Image src={"/svg/express.svg"} alt="express" width={20} height={20} className="bg-[#eaeaea] rounded-xl p-[2px] " />
              <h5 className="text-xs md:text-base">EXPRESS JS</h5>
            </li>
            <li className="flex gap-2 mt-2">
              <Image src={"/svg/mongodb.svg"} alt="mongodb" width={20} height={20} />
    ...
    },
    {
      ...
      content: (
        <ul className="pl-2 font-semibold">
          <li className="flex gap-2 mt-2">
            <Image src={"/img/bppi.jpeg"} alt="bppi" width={23} height={20} className="rounded-lg" />
