          ...
          >
            <div className="">
              ...
              <input
                ...
                className="bg-[#18191E] border border-[#9CA2A9] text-gray-100 text-sm rounded-lg block w-full p-2 mb-4"
              />
              <label
                htmlFor="subject"
                className="text-white block mb-2 text-sm font-medium"
              ...
              <input
                ...
                className="bg-[#18191E] border border-[#9CA2A9] text-gray-100 text-sm rounded-lg block w-full p-2"
              />
            </div>
            <div className="mb-4">
              <label
            ...
            <button
              type="submit"
              onClick={sendMessage}
              className="bg-purple-400 hover:bg-purple-800 text-white font-medium py-2.5 px-5 rounded-lg w-full"
            >
              Send Message
            </button>
            <div className="">
